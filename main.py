...
class QuotesSpider(scrapy.Spider):
    ...
    def parse_author(cls, response, **kwargs):
        ...
        born_locate = content.xpath('p/span[@class="author-born-location"]/text()').get().strip()
        description = content.xpath('div[@class="author-description"]/text()').get().strip()
        yield AuthorItem(fullname=fullname, born_date=born_date, born_locate=born_locate, description=description)
